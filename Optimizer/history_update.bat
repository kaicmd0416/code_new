...
%ANACONDAPATH%\python -c "from portfolio_updating import portfolio_updating_bu; portfolio_updating_bu()"
...
cd /d "%SCRIPT_DIR%Trading\trading_weight"
%ANACONDAPATH%\python -c "from trading_weight_selecting import trading_weight_combination_history; trading_weight_combination_history()"
