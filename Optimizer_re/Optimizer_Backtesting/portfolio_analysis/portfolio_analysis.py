...
global_config_path=glv.get('backtest_config')
class portfolio_analysis:
    ...
    def portfolio_index_finding(self,score_name):
        df_mode=pd.read_excel(global_config_path,sheet_name='portfolio_info')
        base_score=df_mode[df_mode['portfolio_name']==score_name]['benchmark_score'].tolist()[0]
        return base_score
