...
class weight_constraint:
    def __init__(self,df_score,df_weight,optimizer_args):
        ...
        self.top_weight_upper=optimizer_args.get('top_up')
        self.top_weight_lower=optimizer_args.get('top_lo')
        self.C19U = optimizer_args.get('comp_1_9_up')
        self.C19L = optimizer_args.get('comp_1_9_lo')
        self.C98U = optimizer_args.get('comp_9_8_up')
        self.C98L = optimizer_args.get('comp_9_8_lo')
        self.C87U = optimizer_args.get('comp_8_7_up')
        self.C87L = optimizer_args.get('comp_8_7_lo')
        self.C76U = optimizer_args.get('comp_7_6_up')
        self.C76L = optimizer_args.get('comp_7_6_lo')
        self.C65U = optimizer_args.get('comp_6_5_up')
        self.C65L = optimizer_args.get('comp_6_5_lo')
        self.C54U = optimizer_args.get('comp_6_5_up')
        self.C54L = optimizer_args.get('comp_6_5_lo')
        self.C43U = optimizer_args.get('comp_4_3_up')
        self.C43L = optimizer_args.get('comp_4_3_lo')
        self.C32U = optimizer_args.get('comp_3_2_up')
        self.C32L = optimizer_args.get('comp_3_2_lo')
        self.C20U = optimizer_args.get('comp_2_0_up')
        self.C20L = optimizer_args.get('comp_2_0_lo')
        self.constraint_mode=optimizer_args.get('constraint_mode')
